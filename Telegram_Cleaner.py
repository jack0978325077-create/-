...
def main():
    ...
    print(f"🧠 【雙軌智慧大腦版】啟動！正在載入歷史偵測記憶...")
    db_cache = load_cache()

    print(f"🔍 開始全面掃描 D 槽中包含 '{target_folder_name}' 的媒體與壓縮檔案...")
    ...
    print(f"📂 掃描完畢！共找到 {len(all_files)} 個媒體與壓縮檔案。")
